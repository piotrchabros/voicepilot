...
| 6.5 | [lane:gate] [tdd:required] `AnalysisMsg` wire + IPC: `FromPipeline` に追加（plain-serializable、Phase 5 の WS bridge 互換）、pipeline-host routing、`CopilotBridge.onAnalysis` + preload | 型 + routing + bridge のテスト green | 6.4 | cc:WIP |
